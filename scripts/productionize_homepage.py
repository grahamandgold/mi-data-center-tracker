...
RESPONSIVE_HEADER = """
    <header class="site-header">
      ...
      <button type="button" class="mdct-theme-btn" aria-label="Switch to light mode" aria-pressed="false" title="Switch to light mode"><span class="mdct-theme-icon" aria-hidden="true">☀</span><span class="mdct-theme-label">Light</span></button>
